            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu active" aria-labelledby="navbarDropdown">
                        ...
                        @else
                        <a class="dropdown-item active" href="/processor/registerRefurbisher">Register</a>
                        <div class="dropdown-divider"></div>
                    ...
                    <table id = "table" data-vertable="ver2">
                        ...
                        <tbody>
                            ...
                            <tr class="row100">
                                ...
                                <td class="column100 column5" data-column="column5"><a href="/processor/Refurbish/{{$val->inventory_id}}"><button type="button" class="btn btn-success">Refurbish</button></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
