            ...
            <div class="row">
                <div class="col-md-6 login-form-1">
                    ...
                    <form action = "/user/home" method = "post">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Inventory Location" value="" name="inventory_location" />
                        </div>
                         <div class="form-group">
                            <input type="text" class="form-control" placeholder="Name" value="" name="name" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Location" value="" name="location" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type ="submit" onclick="manufacturerStore" class="btnSubmit" value="Sign Up" />
                        </div>
