...
<body style="font-family: 'Montserrat', sans-serif; background-image: linear-gradient(-25deg, #FFFFFF 0%, #C0C0C0 100%);">
  ...
  @endif
    ...
    <div class="container" style="text-align: center;">
        <h3>Insert New Dumping Stations</h3>
    </div>
        <form action = "/admin/createStation" method="post">
            {{CSRF_FIELD()}}
            <div class="page__demo">
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder="Station Location" name = "location" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Station Location</span>
                    </span>
                </label>
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder="Safety Level" name = "safety" required>
                    <span class="a-field__label-wrap">
                ...
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder="Station Capacity" name = "area" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Area Quantity</span>
                    </span>
                </label>
                <br>
