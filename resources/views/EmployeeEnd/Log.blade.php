    ...
    @if(count($tran) == 1)
		<div class="container-table100">
          ...
          <table data-vertable="ver2">
              ...
              $checks = DB::connection('oracle')->select("SELECT CHECK_OUT_TO FROM INVENTORY WHERE BARCODE = '$barcode->barcode'");
              $res;
              if(count($checks) == 0)
                $res = "In Transport";
              else if($checks[0]->check_out_to == "")
                $res = "In Inventory";
              else
              {
              ...
              ?>
							<tr class="row100">
								...
								<td class="column100 column3" data-column="column3">{{$barcode->condition}}</td>
