...
@endif
	...
	<div class="limiter">
    <?php
        $vals = DB::connection('oracle')->select("Select * FROM EMPLOYEE");
    ?>
		...
		<div class="container-table100">
			<div class="wrap-table100">
              ...
              <div class="input-group mb-3">
                ...
                <th class="column100 column4" data-column="column6">Status</th>
							</tr>
						</thead>
              ...
              @foreach($vals as $val)
                ...
                <td class="column100 column6" data-column="column6">{{$val->status}}</td>
							</tr>
              @endforeach
						</tbody>
					</table>
