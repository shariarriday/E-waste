...
<body style="font-family: 'Montserrat', sans-serif; background-image: linear-gradient(-25deg, #FFFFFF 0%, #C0C0C0 100%);">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2c9368; font-family: 'Montserrat', sans-serif;">
      <a class="navbar-brand" href="/productinfo/TV/{{$id2}}">E-waste Management</a>
    ...
    <div class="container" style="text-align: center;">
        ...
        <form action = "/productinfo/TV" method="post">
            {{CSRF_FIELD()}}
              ...
              <input type="hidden" value = "{{$id2}}" name = "proid">
                <label class="field a-field a-field_a1 page__field">
                    ...
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">TV Name</span>
                    </span>
                </label>
                ...
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder="XXXXXXXX" name = "speaker_model" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Speaker_Model</span>
                    </span>
                </label>

                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXX" name = "screen_size" required>
                    <span class="a-field__label-wrap">
                ...
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXX" name = "battery_power" required>
                    <span class="a-field__label-wrap">
                ...
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXX" name = "cathod_ray_tube_power" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Cathod Tube Power</span>
                    </span>
                </label>
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXX" name = "light_valve_version" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Light Bulb</span>
                    </span>
                </label>

                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXX" name = "logic_board_size" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Logic Board Size</span>
                    </span>
                </label>
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXX" name = "wifi_version" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Wifi</span>
                    </span>
                </label>

                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXX" name = "capacity_voltage" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Voltage Capacity</span>
                    </span>
                </label>
