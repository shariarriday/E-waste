...
<body style="font-family: 'Montserrat', sans-serif; background-image: linear-gradient(-25deg, #FFFFFF 0%, #C0C0C0 100%);">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2c9368; font-family: 'Montserrat', sans-serif;">
      <a class="navbar-brand" href="/productinfo/router/{{$id2}}">E-waste Management</a>
    ...
    <div class="container" style="text-align: center;">
        <h3>Insert New Router</h3>
    </div>
        <form action = "/productinfo/router" method="post">
            {{CSRF_FIELD()}}
              ...
              <input type="hidden" value = "{{$id2}}" name = "proid">
                <label class="field a-field a-field_a1 page__field">
                    ...
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Router Name</span>
                    </span>
                </label>
                ...
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "xxxxx" name = "switch_" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Switch Model</span>
                    </span>
                </label>
                <br>
