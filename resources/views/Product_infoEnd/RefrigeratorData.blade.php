...
<body style="font-family: 'Montserrat', sans-serif; background-image: linear-gradient(-25deg, #FFFFFF 0%, #C0C0C0 100%);">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2c9368; font-family: 'Montserrat', sans-serif;">
      <a class="navbar-brand" href="/productinfo/refrigerator/{{$id2}}">E-waste Management</a>
    ...
    <div class="container" style="text-align: center;">
        <h3>Insert New Refrigerator</h3>
    </div>
        <form action = "/productinfo/refrigerator" method="post">
            {{CSRF_FIELD()}}
              ...
              <input type="hidden" value = "{{$id2}}" name = "proid">
                <label class="field a-field a-field_a1 page__field">
                    ...
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Refrigerator Name</span>
                    </span>
                </label>
                ...
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder="XXXXXXXX" name = "copper_condenser" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Copper Condenser Coil Version</span>
                    </span>
                </label>

                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "water/air/coolant" name = "condenser" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Condenser Material</span>
                    </span>
                </label>
                <br>
                <label class="field a-field a-field_a1 page__field">
                    <input class="field__input a-field__input" placeholder= "XXXXXXXXX" name = "sensing_bulb" required>
                    <span class="a-field__label-wrap">
                        <span class="a-field__label">Sensing Bulb Model</span>
                    </span>
                </label>
                <br>
