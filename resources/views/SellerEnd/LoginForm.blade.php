        ...
        <div class="row">
            <div class="col-md-4 login-form-1">
                ...
                <form action = "/seller/home" method = "post">
                    ...
                    <div class="form-group">
                        <a href="/seller/IndividualSellerReg" class="ForgetPwd">Create Account</a>
                    </div>
                </form>
            </div>
            <div class="col-md-4 login-form-2">
                <h3>Login for Buyer</h3>
                  <form action = "/seller/Buyerhome" method = "post">
                    {{CSRF_FIELD()}}
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Your Email *" value="" name = "email"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="/seller/BuyerReg" class="ForgetPwd" value="Login">Create Account</a>
                    </div>
                </form>
            </div>
        </div>
