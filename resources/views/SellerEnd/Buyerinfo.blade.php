...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <?php
        $vals = DB::connection('oracle')->select("Select * FROM BUYER WHERE BUYER_ID = '$id' "); //write any query you need, I am writing to show the                                                                     //employees information
    ?>
					...
					<table data-vertable="ver1">
						<thead>
							<tr class="row100 head">
								...
								<th class="column100 column2" data-column="column2">Loctation</th>
								<th class="column100 column3" data-column="column3">Transaction id</th>
						...
						<tbody>
							...
							<tr class="row100">
								...
								<td class="column100 column3" data-column="column3">{{$val->transaction_id}}</td>
