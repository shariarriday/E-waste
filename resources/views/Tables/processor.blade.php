...
<div class="container" >
 ...
 <form method='POST' action='/processorstore' > <!change tablestore with your table name>
    {{ csrf_field() }}
    ...
    <div class="input-group mb-3 input-group-sm">
      <div class="input-group-prepend">
        <span class="input-group-text">Processor Name</span>
      </div>
    ...
    <div class="input-group mb-3 input-group-sm">
      <div class="input-group-prepend">
        <span class="input-group-text">Processor Location</span>
      </div>
