...
SET DEFINE OFF;
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1000','ZAK',null,'GULISTAN','ALIEXPRESS','UGANDA');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1001','ZAKA',null,'GULI','ALIEXPRESS1','UGANDA1');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1002','ZAKB',null,'TIKATULI','ALIEXPRESS2','UGANDA2');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1003','ZAKC',null,'TIKA','ALIEXPRESS3','UGANDA3');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1004','ZAKD',null,'TULI','ALIEXPRESS4','UGANDA4');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1005','ZAKE',null,'TONGI','ALIEXPRESS5','UGANDA5');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1006','ZAKF',null,'TONGI1','ALIEXPRESS6','UGANDA6');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1007','ZAKG',null,'DOHS','ALIEXPRESS7','UGANDA7');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1008','ZAKH',null,'BHANGA','ALIEXPRESS8','UGANDA8');
Insert into C##RIDAY.MANUFACTURER (PROVIDER_ID,CONTACT_NAME,MANUFACTURE_TO,INVENTORY_LOCATION,NAME,LOCATION) values ('1009','ZAKI',null,'BONGO','ALIEXPRESS9','UGANDA9');
